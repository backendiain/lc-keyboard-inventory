...
namespace Jmx.LC.KeyboardInventory.UI
{
    internal class GUILoader : MonoBehaviour
    {
        ...
        private string[] _toolbarStrings = { "AI Modification/Spawning", "Host Settings", "Time Settings", "Scrap Settings" };
        ...
        public bool AreNumKeyInventoryBindingsEnabled;
        public bool IsGUIForHost;
        #endregion
        ...
        private void Awake()
        {
            KeyboardInventoryModBase._mls.LogInfo("GUILoader loaded.");      
        ...
        {
            KeyboardInventoryModBase.mls.LogInfo("The GUILoader was destroyed :(");
        }
